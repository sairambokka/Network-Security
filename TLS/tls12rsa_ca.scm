(herald "Cookie Authentication with TLS 1.2 RSA"
	(bound 12)
	)
...
(defskeleton ca
  (vars (u s ca name) (p password) (cr sr random32) (pms random48) (spk akey))
...
(defskeleton ca
  (vars (s ca name) (cr sr random32) (pms random48) (spk akey))
...
(defskeleton ca
  (vars (s ca name) (cr sr random32) (pms random48) (cookie data) (spk akey))
...
(defgoal ca
  (forall
    ((any mesg) (cookie data) (response httpdata) (request httpreq)
      ...
      (cookiestor locn) (z z-0 strd) (spk akey))
    (implies
